...
| [Master Spec](./docs/FPA_Master_Spec_v1.docx) | Single source of truth: product + solution design + workflow + commentary learning |
| [Synthetic Data Spec](./docs/synthetic-data-spec.json) | Dimension hierarchies and data generation rules |
| [Master Sprint Plan](./docs/MASTER_SPRINT_PLAN.md) | Sprint-by-sprint build plan with acceptance criteria |
| [Testing Framework](./docs/TESTING_FRAMEWORK.md) | Test strategy, conventions, and how to run tests |
| [API Reference](./docs/API_REFERENCE.md) | All 50 endpoints across 3 services |
| [Architecture](./docs/ARCHITECTURE.md) | ADRs, data flow, system overview |
